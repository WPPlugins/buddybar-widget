 ...
 * This action is documented in includes/class-buddybar-widget-activator.php
 */
function activate_buddybar_widget() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-buddybar-widget-activator.php';
	Buddybar_Widget_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-buddybar-widget-deactivator.php
 */
function deactivate_buddybar_widget() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-buddybar-widget-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-buddybar-widget.php';
